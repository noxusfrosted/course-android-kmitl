package kmitl.lab05.nathapath58070040.simplemydot.fragment;
...
import kmitl.lab05.nathapath58070040.simplemydot.R;
import kmitl.lab05.nathapath58070040.simplemydot.model.Colors;
import kmitl.lab05.nathapath58070040.simplemydot.model.Dot;
import kmitl.lab05.nathapath58070040.simplemydot.model.Dots;
import kmitl.lab05.nathapath58070040.simplemydot.view.DotView;
...
public class DotViewFragment extends Fragment implements DotView.OnDotViewPressListener, Dots.OnDotsChangeListener, View.OnClickListener{
    ...
    private void randomDot() {
        ...
        Dot newDot = new Dot(centerX, centerY, 100-new Random().nextInt(50), new Colors().getColor());
        dots.addDot(newDot);
    }
    ...
    private Uri getUriFile() {
        ...
        return FileProvider.getUriForFile(getContext(), "kmitl.lab05.nathapath58070040.simplemydot.fileprovider", newFile);
    }
    ...
    public void onDotViewPressed(int x, int y, String status) {
        ...
        if (dotPosition == -1) {
            Dot newDot = new Dot(x, y, 100-new Random().nextInt(50), new Colors().getColor());
            dots.addDot(newDot);
        } else {
